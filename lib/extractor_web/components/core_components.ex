defmodule ExtractorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExtractorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExtractorWeb.Gettext, "errors", msg, opts)
    end
  end
